  ...
  const pieChartOptions = {
    ...
    series: [{
      ...
      data: [
        ...
        { name: 'Marketing', y: 20, color: '#0ea5e9' },
        { name: 'Sales', y: 10, color: '#10b981' },
        { name: 'Other', y: 10, color: '#6366f1' }
      ]
    }],
    credits: { enabled: false }
  };
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="p-6 rounded-xl border shadow-sm flex flex-col items-center" style={{ backgroundColor: colors.sidebar, borderColor: colors.accent + '20' }}>
          <h3 className="font-bold text-lg mb-6 w-full text-left" style={{ color: colors.text }}>Job Distribution by Industry</h3>

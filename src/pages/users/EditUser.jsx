...
function EditUser() {
  ...
  useEffect(() => {
    ...
    if (found) {
      setFormData({
          ...
          social: found.social || { github: '', linkedin: '', portfolio: '' }
      });
    } else {
  ...
  const labelStyle = { color: colors.textSecondary, fontSize: '12px', fontWeight: 'bold', marginBottom: '8px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.05em' };
  ...
  return (
    <div className="w-full mx-auto pb-20 pt-4 px-4 h-full overflow-auto">
      <div className="flex items-center gap-4 mb-8 max-w-4xl mx-auto">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: colors.text }}>Edit User Identity</h1>
          <p className="text-xs font-bold opacity-40 uppercase tracking-widest">Update Student Information</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="p-8 rounded border shadow-sm space-y-6" style={{ backgroundColor: colors.sidebar || colors.background, borderColor: colors.accent + '20' }}>
               <h3 className="text-sm font-bold opacity-40 uppercase tracking-widest border-b pb-2 mb-4" style={{ borderColor: colors.accent + '10' }}>Personal Information</h3>
          ...
          <div className="p-8 rounded border shadow-sm space-y-6" style={{ backgroundColor: colors.sidebar || colors.background, borderColor: colors.accent + '20' }}>
               <h3 className="text-sm font-bold opacity-40 uppercase tracking-widest border-b pb-2 mb-4" style={{ borderColor: colors.accent + '10' }}>Academic Details</h3>
          ...
          {/* Section: Skills & Social */}
           <div className="p-8 rounded border shadow-sm space-y-6" style={{ backgroundColor: colors.sidebar || colors.background, borderColor: colors.accent + '20' }}>
               <h3 className="text-sm font-bold opacity-40 uppercase tracking-widest border-b pb-2 mb-4" style={{ borderColor: colors.accent + '10' }}>Skills & Social Profiles</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <button
                type="submit"
                className="flex-1 py-4 rounded font-black text-xs uppercase tracking-widest shadow-lg active:scale-95 transition-all flex items-center justify-center gap-3 cursor-pointer hover:bg-opacity-90"

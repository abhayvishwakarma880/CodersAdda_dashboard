  ...
  return (
    <div className="w-full mx-auto pb-20 pt-4 px-4 h-full overflow-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: colors.text }}>Edit Quiz</h1>
          <p className="text-xs font-bold opacity-40 uppercase tracking-widest">Update assessment data</p>
        </div>
      </div>

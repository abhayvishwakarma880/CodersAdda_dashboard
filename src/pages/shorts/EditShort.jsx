...
function EditShort() {
  ...
  const { shorts, updateShort } = useData();
  ...
  return (
    <div className="w-full mx-auto pb-20 pt-4 px-4 h-full overflow-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: colors.text }}>Edit Short</h1>
          <p className="text-xs font-bold opacity-40 uppercase tracking-widest">Update short details</p>
        </div>
      </div>

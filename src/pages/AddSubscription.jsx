...
import { ArrowLeft, Save, X, CreditCard, Clock, CheckCircle2, Plus, Trash2, Hash } from 'lucide-react';
...
function AddSubscription() {
  ...
  const { subscriptions, addSubscription, updateSubscription } = useData();
    ...
    <div className="w-full mx-auto pb-20 pt-4 px-4 h-full overflow-auto">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-6">
            <div className="p-8 rounded-xl border shadow-sm space-y-8" style={{ backgroundColor: colors.sidebar || colors.background, borderColor: colors.accent + '20' }}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                        ...
                        <select 
                            ...
                            className="w-full px-4 py-3 rounded-lg border outline-none text-sm font-semibold cursor-pointer"
                            style={inputStyle}
                        >
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            placeholder="e.g. 299"
                            className="w-full pl-10 pr-4 py-3 rounded-lg border outline-none text-sm font-semibold transition-all"
                            style={inputStyle}
                        />
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <label style={labelStyle}>Plan Benefits</label>
                        <button 
                            type="button"
                            onClick={handleAddBenefit}
                            className="text-[10px] font-black uppercase tracking-widest flex items-center gap-1 transition-all hover:opacity-100 opacity-60"
                        ...
                        {formData.benefits.map((benefit, index) => (
                            <div key={index} className="flex gap-2">
                                <input 
                                    ...
                                    className="flex-1 px-4 py-2.5 rounded-lg border outline-none text-sm font-semibold"
                                    style={inputStyle}
                                />
                                <button 
                                    type="button"
                                    onClick={() => handleRemoveBenefit(index)}
                                    className="p-2.5 text-red-500 rounded-lg hover:bg-red-50 transition-all border border-transparent"
        ...
        <div className="lg:col-span-4 space-y-6">
            <div className="p-8 rounded-xl border shadow-sm space-y-6 sticky top-4" style={{ backgroundColor: colors.sidebar || colors.background, borderColor: colors.accent + '20' }}>
                <div className="space-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {['Active', 'Disabled'].map(stat => (
                            <button 
                                ...
                                className="py-3 rounded-lg border text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer"
                                style={{ 
                ...
                <div className="pt-6 space-y-3">
                    <button 
                        type="submit"
                        className="w-full py-4 rounded-xl font-black text-xs uppercase tracking-widest shadow-lg active:scale-95 transition-all flex items-center justify-center gap-3"
                    ...
                    <button 
                        ...
                        className="w-full py-4 rounded-xl font-black text-xs uppercase tracking-widest border opacity-60 hover:opacity-100 transition-all flex items-center justify-center gap-3"

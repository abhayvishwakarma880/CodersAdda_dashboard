...
function AddCourse() {
  ...
  const { categories, addCourse, instructors } = useData();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex gap-3 w-full">
              <div className="space-y-1 w-full">
                ...
                <ModernSelect
                  options={instructors.map(ins => ({ value: ins.name, label: ins.name }))}
                    ...
                    onClick={() =>
                      setFormData({
                        ...
                        price:
                          type === "Free"
                            ? ""
                            : formData.Oprice || formData.Cprice,
                      })
                    }
              ...
              <div className="space-y-1 flex gap-3">
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, Oprice: e.target.value })
                    }
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, Cprice: e.target.value })
                    }
                    placeholder="Enter amount"
                    className="w-full px-4 py-2 rounded-md border outline-none text-sm"
                    style={{
            ...
            <div className="space-y-1">
              ...
              <ModernSelect
                options={[
                  ...
                  { value: "Top Course", label: "Top Course" },
                  { value: "Popular Course", label: "Popular Course" },
                  { value: "Trending Course", label: "Trending Course" }
                ]}
            ...
            {["Active", "Disabled"].map((stat) => (
              <button
                ...
                style={{
                  ...
                  color:
                    formData.status === stat ? colors.background : colors.text,
                  borderColor:

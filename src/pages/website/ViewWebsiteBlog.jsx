...
import { ArrowLeft, Edit, Trash2, FileText, Calendar, Clock } from 'lucide-react';
...
function ViewWebsiteBlog() {
  ...
  const { websiteBlogs, deleteWebsiteBlog } = useWebsiteData();
  ...
  if (!blog) {
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-lg" style={{ color: colors.textSecondary }}>Blog not found</p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                ...
                <div
                  className="p-4 rounded-lg text-center"
                  style={{ backgroundColor: blog.status === 'Active' ? '#22C55E20' : '#EF444420' }}
                >
                  <div className="text-2xl font-bold" style={{ color: blog.status === 'Active' ? '#22C55E' : '#EF4444' }}>
                    {blog.status}
                  </div>
                  <div className="text-sm font-semibold" style={{ color: colors.textSecondary }}>
                    Status

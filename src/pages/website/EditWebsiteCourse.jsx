...
function EditWebsiteCourse() {
  ...
  const { websiteCourses, updateWebsiteCourse } = useWebsiteData();
  ...
  const [formData, setFormData] = useState({
    image: course?.image || '',
    courseType: course?.courseType || 'Beginner',
    title: course?.title || '',
  ...
  const handleInstructorImageChange = (e) => {
    ...
    if (file) {
      ...
      const reader = new FileReader();
      reader.onloadend = () => {
        setFormData({ ...formData, instructorImage: reader.result });
      };
      reader.readAsDataURL(file);
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    updateWebsiteCourse(id, formData);
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    type="button"
                    onClick={() => document.getElementById('instructorImageInput').click()}

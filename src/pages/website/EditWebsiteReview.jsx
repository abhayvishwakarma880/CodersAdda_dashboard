...
function EditWebsiteReview() {
  ...
  const { websiteReviews, updateWebsiteReview } = useWebsiteData();
  ...
  const handleSubmit = (e) => {
    ...
    updateWebsiteReview(id, formData);
  ...
  const renderStarRating = () => {
    return (
      <div className="flex items-center gap-1">
        ...
        <span className="ml-2 text-sm font-semibold" style={{ color: colors.text }}>
          {formData.rating}/5
        </span>
      </div>
    );

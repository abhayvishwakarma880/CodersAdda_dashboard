...
import { ArrowLeft, Edit, Trash2, Globe, User, Clock, BarChart3 } from 'lucide-react';
...
function ViewWebsiteCourse() {
  ...
  const { websiteCourses, deleteWebsiteCourse } = useWebsiteData();

  const course = websiteCourses.find(c => c.id === id);

  if (!course) {
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-lg" style={{ color: colors.textSecondary }}>Course not found</p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <div
                  className="p-4 rounded-lg text-center"
                  style={{ backgroundColor: getStatusColor(course.status) + '20' }}
                >
                  <div className="text-2xl font-bold" style={{ color: getStatusColor(course.status) }}>
                    {course.status}
                  </div>
                  <div className="text-sm font-semibold" style={{ color: colors.textSecondary }}>
                    Status

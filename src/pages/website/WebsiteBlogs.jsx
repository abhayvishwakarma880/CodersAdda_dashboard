...
import { Plus, Eye, Edit, Trash2, Search, Grid, List, FileText } from 'lucide-react';
...
function WebsiteBlogs() {
  ...
  const { websiteBlogs, deleteWebsiteBlog, updateWebsiteBlog } = useWebsiteData();
  ...
  const handleStatusToggle = (id, currentStatus) => {
    ...
    updateWebsiteBlog(id, { status: newStatus });
      ...
      <div className="flex-1 overflow-auto">
        {filteredBlogs.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64">
            <FileText size={48} style={{ color: colors.textSecondary, opacity: 0.5 }} />
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => navigate(`/dashboard/website/blogs/view/${blog.id}`)}
                    ...
                    <button
                      onClick={() => navigate(`/dashboard/website/blogs/edit/${blog.id}`)}
                      className="flex-1 flex items-center justify-center gap-1 py-2 px-3 rounded text-xs font-semibold transition-all"
                      style={{

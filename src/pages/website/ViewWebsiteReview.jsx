...
import { ArrowLeft, Edit, Trash2, MessageSquare, User, Star } from 'lucide-react';
...
function ViewWebsiteReview() {
  ...
  const { websiteReviews, deleteWebsiteReview } = useWebsiteData();

  const review = websiteReviews.find(r => r.id === id);

  if (!review) {
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-lg" style={{ color: colors.textSecondary }}>Review not found</p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                ...
                <div
                  className="p-4 rounded-lg text-center"
                  style={{ backgroundColor: review.status === 'Active' ? '#22C55E20' : '#EF444420' }}
                >
                  <div className="text-2xl font-bold" style={{ color: review.status === 'Active' ? '#22C55E' : '#EF4444' }}>
                    {review.status}
                  </div>
                  <div className="text-sm font-semibold" style={{ color: colors.textSecondary }}>
                    Status

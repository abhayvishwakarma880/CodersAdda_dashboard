    ...
    <div className='min-h-screen w-full bg-linear-to-br from-blue-50 to-indigo-100 flex justify-center items-center p-4'>
      <div className='w-full max-w-sm bg-white rounded-xl shadow-xl p-6 sm:p-8'>
        ...
        <form onSubmit={handleSubmit} className='space-y-5'>
          ...
          <button 
            type='submit'
            className='cursor-pointer w-full bg-black text-white font-semibold py-3 px-4 rounded-lg hover:bg-gray-800 transform hover:scale-[1.02] transition-all duration-200 shadow-lg'
          >
            Submit
          </button>
        </form>
